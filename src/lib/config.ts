...
import { PlayerPosition, PositionConfig, SortOption } from './types';
...
export const POSITION_CONFIG: Record<PlayerPosition, PositionConfig> = {
  'GKP': {
    icon: '🧤',
    label: 'GKP',
    fullName: 'Goalkeeper',
...
export const getSortLabelByKey = (sortKey: string): string => {
...
export const TABLE_COLUMN_STYLES: Record<string, any> = {
  'web_name': {
